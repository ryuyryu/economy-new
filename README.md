# economy-new
# 今やっていること
スタート画面の設計、江橋からの画像データかCSSかでデザイン予定。Game名の表示やタップでスタートを機能として実装します。
ページの切り替え先はgame_screen.html。画像データがないの一先ずコードのみで設計中
...
## 使い方
ブラウザで `public/index.html` を開き、`開始` ボタンをクリックするとゲームがスタートします。
